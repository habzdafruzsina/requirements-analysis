...
\subsection{Weboldal}
A weboldal két főbb részre tagolható: a megosztási felületre, mely programok megosztására, illetve véleményezésére, megbeszélésére ad lehetőséget, valamint a dokumentációra, ahol a felhasználók egyszerűen kereshetnek számukra szükséges információkat az alkalmazásról.

\subsubsection{Megosztási felület}
A megosztási felület lehetőséget ad a felhasználók által készített programok megosztására, újrafelhasználására. Kód alapú kollaborációra egyelőre nincs igény, későbbi bővítések során lehet ehhez szükséges követelmények bevezetéséről szó. Viszont más kódjainak értékelésére lehetőséget kell biztosítania, illetve egy fórum jellegű felülettel kell rendelkeznie a programokkal kapcsolatos beszélgetések lebonyolításához.
